...
function DepressionTest() {
  ...
  const fetchQuestions = async () => {
    try {
        const response = await axios.get( API_HOST + "/test/getQuestions/" + 2);
  ...
  return (
    <div className="App">
      <div className="Content">
        {showResults ? (
          <ResultPage obtainedScore={score} totalScore={questions.length * 3} text={"Depression"}/>
        ) : (
          <>
            <h1 className="TestHeading">Depression Test</h1>
