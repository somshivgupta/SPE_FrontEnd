...
function AnxietyTest() {
    ...
    const fetchQuestions = async () => {
      try {
          const response = await axios.get( API_HOST + "/test/getQuestions/" + 3);
    ...
    return (
      <div className="App">
        <div className="Content">
          {showResults ? (
            <ResultPage obtainedScore={score} totalScore={questions.length * 3} text={"Anxiety"} />
          ) : (
            <>
              <h1 className="TestHeading">Anxiety Test</h1>
